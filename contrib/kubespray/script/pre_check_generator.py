...
def main():
    ...
    output_path = os.path.expanduser(args.output) # os.path.expanduser将～补全
    ...
    # add machine to different computing device group
    ...
    # generate_template_file(template_file_path, output_path, map_table):
