...
ansible-playbook -i ${HOME}/prophet-deploy/cluster-cfg/hosts.yml passwordless-ssh.yml || exit $?

ansible-playbook -i ${HOME}/prophet-deploy/cluster-cfg/hosts.yml drivers-install.yml || exit $?

ansible-playbook -i ${HOME}/prophet-deploy/cluster-cfg/hosts.yml docker-runtime-setup.yml || exit $?

ansible-playbook -i ${HOME}/prophet-deploy/cluster-cfg/hosts.yml set-host-daemon-port-range.yml || exit $?
