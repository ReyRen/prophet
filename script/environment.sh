...
echo "Clone kuberspray source code from github to ${HOME}/prophet-deploy"
sudo rm -rf ${HOME}/prophet-deploy/kubespray
git clone -b master https://github.com/kubernetes-sigs/kubespray.git ${HOME}/prophet-deploy/kubespray
cd ${HOME}/prophet-deploy/kubespray
git checkout 699fbd64ab3189000e2a5eed22ac0882d4b4d09c 
cd -
